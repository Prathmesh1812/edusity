...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "514e90e2-de93-4c70-a371-2974e378038d");
    ...
    <div className='contact'>
        ...
        <div className="contact-col">
            <form onSubmit={onSubmit}>
                ...
                <textarea name="message"  rows="6" placeholder="Enter your message" required>Enter your message</textarea>
